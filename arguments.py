...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--ckpt_path', type=str, default='/content/drive/MyDrive/ResultadosLothar/Treegan/cap_earphone/', help='Checkpoint path.')
        self._parser.add_argument('--ckpt_save', type=str, default='tree_CapEarphone_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str, default='tree_CapEarphone_ckpt_1500.pt', help='Checkpoint name to load.')
