...
class Arguments:
    def __init__(self):
        ...
        self._parser.add_argument('--ckpt_save', type=str, default='tree_PlaneChair_ckpt_', help='Checkpoint name to save.')
        self._parser.add_argument('--ckpt_load', type=str, default='tree_ckpt_45.pt', help='Checkpoint name to load.')
